<?php
    ...
    // DELETE Endpoint
    $urlDelete = "https://apirest.pablogaray.com.ar/pacientes.php";
    ...
    curl_setopt_array($ch, [
        ...
        CURLOPT_POSTFIELDS => json_encode($deleteUser),
        CURLOPT_HTTPHEADER => [
            "Content-Type: application/json",
    ...
    if ($httpCode === 200) {
        ...
        if (!isset($data->result->PacienteId)) {
            ...
            // Mostramos el dato del usuario eliminado con la respuesta del Id
            echo "Paciente con ID: " . $data->result->PacienteId . " ha sido eliminado correctamente.<br>";
